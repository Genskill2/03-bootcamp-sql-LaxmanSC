...
ALTER TABLE books
RENAME COLUMN publisher TO pub;

INSERT INTO books (title, pub) VALUES ( 'The C Programming Language', '1');
INSERT INTO books (title, pub) VALUES ( 'The Go Programming Language', '1');
INSERT INTO books (title, pub) VALUES ( 'The UNIX Programming Environment', '1');
INSERT INTO books (title, pub) VALUES ( 'Cryptonomicon', '2');
INSERT INTO books (title, pub) VALUES ( 'Deep Work', '3');
INSERT INTO books (title, pub) VALUES ( 'Atomic Habits', '4');
INSERT INTO books (title, pub) VALUES ( 'The City and The City', '5');
INSERT INTO books (title, pub) VALUES ( 'The Great War for Civilisation', '6');

ALTER TABLE books
RENAME COLUMN pub TO publisher;
